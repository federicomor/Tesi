...
##### Per le varie aggiunte comunque manderò un pdf con sottolineate/evidenziate bene le parti nuove.
<!-- perché magari quello che scrivo qui lo aggiorno nel mentre che vado avanti -->
...
Per le metriche ci sta, tolgo. Per i fit non credo, quelli con solo target non sembra vogliano cambiare idea. Ho provato cambiando di poco i parametri, seed, ecc, ma non si accordano mai perfettamente. Ma comunque avevo messo dei commenti riguardo a perché entrambe le soluzioni fossero ragionevoli, e non essendo un cluster "esatto" forse ci sta che escano leggermente diverse.
...
Per i fit NA senza spazio non credo di riuscire perché avevo impostato gli NA a caso e non mi sono salvato i dati o il seed che ha determinato quali coppie (j,t) venissero rimosse. Però comunque gli MSE un po' forse compensano questa informazione/questo plot dei CI mancante. Per azzerare invece un'intera time series provo invece.
