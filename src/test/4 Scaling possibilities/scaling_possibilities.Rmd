...
abline(h=1,col="#eeeeee",lty=1)
abline(h=0.5,col="#dddddd",lty=2)
abline(h=1.75,col="#dddddd",lty=2)

title(main="n=10",line=-0.1)
cols = colora(8,"div",seed_div = "Paired",show = 0)
cexs = 1.8
points(x=timespan_plots + dxC,y = spCt[1,],   pch=15, cex=cexs, col=cols[1])
points(x=timespan_plots + dxC,y = spCts[1,],  pch=16, cex=cexs, col=cols[3])
points(x=timespan_plots + dxJ,y = spJt[1,],   pch=0, cex=cexs, col=cols[2], lwd=1.2)
points(x=timespan_plots + dxJ,y = spJts[1,],  pch=1, cex=cexs, col=cols[4], lwd=1.2)
points(x=timespan_plots + dxJ,y = spJtsc[1,] ,pch=2, cex=cexs, col=cols[5], lwd=1.2)
points(x=timespan_plots + dxJ,y = spJtscl[1,],pch=5, cex=cexs, col=cols[7], lwd=1.2)
```
