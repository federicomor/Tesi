...
# for (i in 2:2){
	...
	# pdf(file=paste0("summary_performance_n",nunits_tests[i],"_response.pdf"),
	pdf(file=paste0("summary_performance_n",nunits_tests[i],"_response_lines.pdf"),
		# width = 6,height = 4)
		width = 6.5,height = 4)
}
...
########### NEW LINES ###########
lines(x=timespan_plots + dxC,y = spCt[i,],   col=cols[1], lwd=1)
lines(x=timespan_plots + dxC,y = spCts[i,],  col=cols[3], lwd=1)
# lines(x=timespan_plots + dxJ,y = spJt[i,],   col=cols[2], lwd=1.7)
# lines(x=timespan_plots + dxJ,y = spJts[i,],  col=cols[4], lwd=1.7)
# lines(x=timespan_plots + dxJ,y = spJtsc[i,] ,col=cols[5], lwd=1.7)
# lines(x=timespan_plots + dxJ,y = spJtscl[i,],col=cols[7], lwd=1.7)
...
legend("bottom",
       ...
       legend = c("C response",
       		      ...
       		      "J response",
       		      "J response+space",
       		      "J response+space+Xcl",
       		      "J response+space+Xcl+Xlk"),
