...
prima della modifica NA
Elapsed time: 5 seconds, 66 milliseconds
LPML: -71.0356621197883 (the higher the better)
WAIC: 115.7803058815076 (the lower the better)


col test NA al nuove tempo 7
Elapsed time: 32 seconds, 812 milliseconds
LPML: -79.11521717334799 (the higher the better)
WAIC: 133.1380673800629 (the lower the better)

Elapsed time: 1 minute, 59 seconds, 885 milliseconds (not real, it was logging)
LPML: -63.85166419645225 (the higher the better)
WAIC: 109.08046537523906 (the lower the better)
...
```{r}
plot(drpm1$alpha[,2],type="l",ylim=c(0,1))
plot(rout$alpha,type="l",ylim=c(0,1))
```
...
# for (it in 0:10){
yredJ=t(rout$fitted[,,size(rout$fitted)[3]-6])
