...
# ym = as.matrix(y)
# sm = as.matrix(s_std)
# as = c(0.01, 0.1,0.3,0.5, 1, 1.5, 2)
# bs = c(0.01, 0.1,0.3,0.5, 1, 1.5, 2)
# for (i in 1:length(as)){
# 	for (j in 1:length(bs)){
# 	# a_sigma  = as[i]; b_sigma  = bs[i]
# 	a_tau    = as[i]; b_tau    = bs[j]
# 	# a_lambda = as[i]; b_lambda = bs[i]
# 	cat(crayon::red("##################",i,j,"\n"))
# 	cat(crayon::red("a =",as[i]," b =",bs[j],"\n"))
...
```{r}
save(drpm1,rout,file="space_full_100k_run2.Rdata")
```
